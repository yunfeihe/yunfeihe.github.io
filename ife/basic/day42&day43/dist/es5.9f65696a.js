...
function Cooker(name, payment) {
    Staff.call(this, name, payment);
}

Cooker.prototype = Object.create(Staff.prototype);
Cooker.prototype.constuctor = Cooker;
...
Customer.prototype.order = function (waiter) {
    for (var _len = arguments.length, dishes = Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {
        dishes[_key - 1] = arguments[_key];
    }
...
//# sourceMappingURL=/es5.9f65696a.map